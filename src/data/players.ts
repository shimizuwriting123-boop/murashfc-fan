...
export const players: Player[] = [
  ...
  // ============================================================
  {
    ...
    career: [
      ...
      "モンテディオ山形（2017〜2018）",
      "FC東京（2019〜2024）",
      "名古屋グランパス（2025／同年限りで現役引退）",
    ],
    feature:
      "Jリーグ通算194試合出場のベテラン守護神。FC東京で5年間正GKを務めた。足元・1対1の強さ・コーチングが武器で、YouTubeチャンネル登録者は2万人超。GKスクール「Kodama Academy」代表も務める実業家・教育者でもある。",
    personalityNote:
      "1987年生まれ、大阪府吹田市出身のベテランGK。ガンバ大阪の下部組織や京都パープルサンガユースを経て関西大学へ進み、2009年のデンソーカップでは選抜の主将として優勝を経験した。\n\nプロ入り後は京都サンガF.C.、愛媛FC、モンテディオ山形、FC東京、名古屋グランパスと渡り歩き、とりわけ愛媛と山形では長く正GKを務めた。名古屋グランパスでプレーした2025シーズンを最後に、J1で9試合、J2で179試合、J3で6試合、Jリーグ通算194試合を積み上げた現役生活へ区切りをつけている。\n\nシュートストップだけでなく、足元の技術と後方からの配球にも定評があり、相手との1対1では距離を詰める判断が速い。守備陣へ声をかけながら最終ライン全体を動かせる、経験に裏打ちされたGKだ。\n\n現役中からGKスクール「Kodama Academy」を運営し、小学生年代を中心にゴールキーパーの専門指導を行う。2025年には東村山校の開校も発表されるなど、プロ個人の活動にとどまらない育成事業として拠点を広げている。自身のYouTubeでも試合やトレーニングの裏側、GK特有の判断やプロ生活で得た経験を発信しており、プレーだけでなく言語化して伝える力も児玉の持ち味となっている。",
  ...
  },
  {
    ...
    career: [
      ...
      "ラインメール青森FC（2023）",
      "ヴィアティン三重（2024）",
      "FUKUOKA CITY24（オーナー兼選手）",
    ],
    feature:
      "J2リーグ通算105試合6得点を記録した元プロサッカー選手。東福岡高校時代には全国高校サッカー選手権大会の優秀選手に選出。明治大学時代にはユニバーシアード日本代表にも選出された実力派FW。",
    personalityNote:
      "熊本ユナイテッドSCから名門・東福岡高校へ進んだ大型ストライカー。全国高校サッカー選手権では初戦で2得点を挙げるなど、体の強さと利き足にこだわらない決定力で早くから注目を集めた。2014年にはU-18日本代表候補、2015年には日本高校選抜に選出され、プロ入り前から世代を代表するフォワードの一人として評価されていた。\n\n明治大学では試練も味わっている。2年時に右膝、3年時に左膝と前十字靭帯を相次いで断裂し、二度の大怪我で約1年半を棒に振った。それでも長いリハビリを乗り越えてピッチへ復帰し、最終学年には主将としてチームを牽引。総理大臣杯準々決勝では終盤に決勝点を沈め、得点前に仲間へ「俺が決める。俺に出してくれ」と伝えていたという、責任を背負って結果を出す勝負強さを示した。大学ではユニバーシアード日本代表にも選ばれている。\n\n卒業後はアビスパ福岡に加入し、モンテディオ山形、ラインメール青森FC、ヴィアティン三重を渡り歩いてJ2通算105試合6得点を記録。176cm・75kgの体格を生かして相手を背負うポストプレーやゴール前の競り合いを得意とし、味方の攻撃を前線で収めながら自らフィニッシュにも入れるタイプだ。\n\nプロキャリアを一区切りした後は、福岡を拠点とするFUKUOKA CITY24のオーナー兼選手として活動しているとされる。サッカーと地域、未来をつなぐことを掲げ、競技を続けながらクラブづくりにも携わっている。",
    researchedProfile: true,
  ...
  },
  {
    ...
    career: [
      ...
      "リンドバロッサ京都",
      "VOLVER OSAKA",
      "ソサイチ日本代表（2024・2025・2026／2024アジアカップ優勝、2025ブラジルW杯）",
    ],
    kakitaniComment:
  ...
  },
  {
    ...
    featuredVideos: [
      {
        url: "https://www.youtube.com/watch?v=iKzKSknOHd4",
        videoId: "iKzKSknOHd4",
        title:
          "【真相】ブラジル大会最後の言葉の真相｜５年間のブランク｜キャプテンへの想い｜MURASH FC Podcast＃５　AGATA",
      },
    ],
    tournamentHistory: [
  ...
  },
  {
    ...
    personalityNote:
      "熊本県出身のディフェンダー。サンフレッチェ広島の育成組織や近畿大学（新人賞・DENSO関西選抜）を経て、卒業後は11人制に加えてソサイチ、フットサルと複数の競技を横断してプレーしてきた。\n\n育成年代にはU-15日本代表に選ばれ、2014年にはU-18Jリーグ選抜にも名を連ねた。当時はFW登録で、現在の守備的な役割とは異なる攻撃の経験を積んでいる。そのバックグラウンドゆえ、DFとして起用される今も得点感覚と前へ出る力を併せ持ち、ボールを奪うだけでなく豊富な運動量を生かして攻撃へ加わっていけるのが特徴だ。\n\nソサイチではVOLVER OSAKAに所属し、2025年・2026年に日本代表メンバーへ選出。2025年のFOOTBALL 7 WORLD CHAMPIONSHIPでは背番号77を着けて世界の強豪と渡り合った。2025年のKT SEVENでは大会MVPとベスト7に輝き、運動量だけでなく勝敗を左右する総合力が高く評価されている。リーグでは2023年2得点、2024年3得点、2025年7得点、2026年3得点と、DF登録ながら掲載時点で通算15得点を積み上げている（数字はシーズン進行で変動）。\n\nさらにフットサルではMIKIHOUSEでもプレーし、2026年の全日本フットサル選手権大会にも登録。11人制・ソサイチ・フットサルの3競技を股にかける稀有な選手として、それぞれで培った判断力と運動量を新生ムラッシュFCに持ち込んでいる。",
    researchedProfile: true,
    kakitaniComment:
      "守備の強度が高く何度も球に行ける、戦える。自身で運ぶドリブルもそつなくできる。キック精度もある。",
    playerMessage:
  ...
  },
  {
    ...
    personalityNote:
      "165cmと小柄ながら、低い重心と左足の技術で違いを生み出すレフティアタッカー。宮城県で育ち、FCセレスタからベガルタ仙台のジュニアユース、ユースへと進んだ。2014年にはベガルタ仙台ジュニアユースの一員として高円宮杯U-15全国大会の登録メンバー入りを果たすなど、中学生年代から全国レベルの競争を経験している。\n\nベガルタ仙台ユースではFWとして先発し、プリンスリーグ東北では青森山田高校セカンドを相手に先制点を記録。東北学院大学でも1年時から総理大臣杯の登録メンバーに入り、背番号8のFWとして全国大会を経験した。現在のドリブルや得点感覚は、こうしたアカデミー時代から磨かれてきたものだ。\n\nムラッシュFCではFW、ソサイチや過去の登録ではMFとしてもプレーする攻撃的な万能型。サイドからの仕掛けだけでなく、中盤でボールを受ける役割にも対応できる。ソサイチ関東リーグ1部のてくてくキッカーズでは2023年1得点、2024年5得点、2025年7得点と年々数字を伸ばし、3シーズン合計13得点。攻撃の中心へと成長を遂げた。2026年からは小田崚平も同じてくてくキッカーズに加わっている。\n\nまた、自身が育った原点のクラブ・FCセレスタでは、選手経験を生かして指導にも携わったという。プレーヤーとしてだけでなく、育成年代へ技術や経験を還元する一面も持っている。",
    researchedProfile: true,
    kakitaniComment:
  ...
  },
  {
    ...
    personalityNote:
      "桐蔭学園高校を卒業すると、日本の大学やクラブではなく海外挑戦という道を選んだ左利きアタッカー。ブラジルのクラブを経てモンテネグロ、スウェーデンへと渡り、若くして異なる国のサッカー文化と競争環境に身を置いた異色の経歴を持つ。\n\n2016年にはモンテネグロの強豪FKスティエスカ・ニクシッチのトライアルに参加。スタッフと監督から評価を受け、短い選考期間で結果を残して1年間の契約を勝ち取った。その後はスウェーデンのIFKヴェルナモでもプレーし、モンテネグロで6試合、スウェーデンのスーペルエッタンで6試合1得点を記録している。\n\n自身がストロングポイントに挙げるのはドリブル。狭い局面でもボールを前へ運び、相手との1対1から攻撃のきっかけを作れる。所属クラブや大会によってFW・MFの両方で登録されてきた攻撃的なユーティリティプレーヤーで、ゴールに近い位置で仕掛けるだけでなく、中盤からボールを運ぶ役割もこなせる。ソサイチではELAGUA TOKYOに登録され、中盤の選手として起用されている。\n\n大学を経てプロを目指す一般的なルートとは大きく異なり、高校卒業後すぐに複数の国で競争してきた経験は、新生ムラッシュFCの中でも際立ったバックグラウンドとなっている。",
    researchedProfile: true,
  ...
  },
  {
    ...
    career: [
      ...
      "フウガドールすみだU20（2021年）",
      "フットサル日本代表（U-19・U-20・U-23）",
      "バサジィ大分（2023年加入〜同年11月退団）",
      "fc vinculo（フットサル）",
      "N（ソサイチ）",
    ],
    feature:
      "年代別フットサル日本代表（U-19・U-20・U-23）。ピヴォ／アラのフットサル選手。サッカーからフットサルに転向し、現在のキャプテン候補。",
    personalityNote:
      "長野県松本市出身、188cm・78kgの大型フットボーラー。日本ウェルネス長野高校からフウガドールすみだの育成組織へ進み、フットサルで頭角を現した。年代別フットサル日本代表としては2018年にU-19、2019年にU-20、2022年にU-23へ選出され、早くから長身と技術を評価されて継続的に代表世代へ名を連ねてきた。\n\n2023年にはFリーグのバサジィ大分へ加入。188cmのフィールドプレーヤーとしてピヴォ・アラの両方に対応できる選手として契約したが、同年11月に双方合意の上で契約を解除した。その後はfc vinculoでフットサルを続けながら、ソサイチのNやムラッシュFCへと活動の場を広げている。\n\n長身を生かしたポストプレーに加え、ドリブルで相手を外せる技術が持ち味。前線で収めるだけでなく、サイドから仕掛け、後方からのビルドアップにも参加できる万能型で、狭い局面で磨いたフットサルの技術を7人制の広いスペースでも発揮している。ムラッシュFCではフランス大会・ブラジル大会に出場し、次期キャプテン候補にも挙げられている。",
    kakitaniComment:
  ...
  },
  {
    ...
    personalityNote:
      "育成年代はFC東京U-15むさしでプレーし、前橋育英高校へ進学。国内の強豪育成環境を経て、高校卒業後はアメリカへ渡るという道を選んだアタッカーだ。\n\n最初に進んだのはマーシャルタウン・コミュニティカレッジ（短大）。ここで15試合中12試合に先発して10得点を挙げ、2021年にはNJCAAオール・リージョンXIのファーストチームに選出された。続くフロリダ国際大学では通算23試合13先発で6得点を記録し、2022年はカンファレンス優勝とNCAAトーナメント・スウィート16、2023年もNCAAトーナメント2回戦進出を経験。段階的にカテゴリーを引き上げていった。\n\nミズーリ州立大学へ移った2024年は18試合11先発で5得点4アシスト、オールMVCセカンドチームに選出され、移籍初年度から攻撃の中心を担った。2025年は開幕戦でシアトル大学を相手に1試合4得点を挙げ、大学の1試合最多得点記録に並ぶ衝撃のスタート。ペンシルベニア州立大学戦、テンプル大学戦でもそれぞれ2得点を重ね、カンファレンスの週間最優秀攻撃選手に複数回選ばれた。\n\n競技だけでなく学業でも高く評価され、2024年・2025年にAcademic All-Districtへ選出。優秀な成績で学部課程を修了し、その後も大学院課程で学びを続ける文武両道の選手だ。\n\nアメリカではFWとして登録され、中央だけでなく流動的に位置を取りながらゴールへ入るのが持ち味。短大からNCAAディビジョン1まで、環境が変わっても各カテゴリーで得点を重ねてきた適応力が最大の強みだ。日本ではMF、アメリカではFWと複数のポジションをこなし、国内のソサイチではNの選手としても名前が挙がっている。",
    researchedProfile: true,
  ...
  },
  {
    ...
    personalityNote:
      "2000年9月1日生まれ、179cm・70kgのサイズを備えたMF。浦和西高校時代からスピードと左足の強烈なキックを評価され、2018年の高校総体埼玉県予選では注目選手の一人として紹介された。強豪校相手にも高い身体能力と左足を発揮し、県内で存在感を示していたという。\n\n「公園でサッカーをしていた」時期からキングスリーグの舞台へたどり着いた異色の経歴の持ち主で、なかしゅん（中村駿介）に見出された無名枠として第4回ブラジル大会に出場した。ソサイチではNに所属し、2025シーズンにはリーグ戦で得点も記録している。11人制ではFCカラスト埼玉南西に背番号2で加わり、社会人サッカーでも実戦経験を積んでいる。\n\n相手守備を押し下げながら前進し、遠い位置からでもゴールを狙える攻撃力が武器。オーナー・柿谷曜一朗が評した「シュートレンジの広さ」は、この左足のパンチ力に裏打ちされている。\n\nムラッシュFCでの目標について、本人は「一番戦っていると思われるくらい活躍したい」という趣旨を語っている。技術だけでなく、球際や運動量、チームのために体を張る姿勢で存在感を示すことを目指している。",
    researchedProfile: true,
    kakitaniComment:
  ...
  },
  {
    ...
    hometown: "愛知県",
    career: [
      "豊川サッカースクール・FC豊橋リトルJセレソン・FC豊橋デューミラン",
      "帝京長岡高校(全国高校選手権優秀選手・2017日本高校選抜)",
      "立正大学",
      "品川CC",
      "WINNER'S",
      "サガン鳥栖（元Jリーガー）",
  ...
  },
  {
    ...
    feature:
      "元ソサイチ日本代表主将（ASIA 7's 2023優勝メンバー）で、後に代表アシスタントコーチも務めた。ブラウブリッツ秋田では2017年のJ3優勝に貢献。第1回メキシコ大会・第2回イタリア大会では選手として出場し、第3回フランス大会でコーチに転身。以降、現在もムラッシュFCのコーチとして活動している。",
    researchedProfile: true,
    ...
    tournamentHistory: [
      ...
      { tournament: "brazil", role: "coach", subRole: "コーチ" },
      { tournament: "rebirth", role: "coach", subRole: "コーチ" },
    ],
  },
  {
    slug: "yuseiNarita",
