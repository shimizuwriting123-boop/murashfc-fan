  ...
  },
  {
    ...
    exhibitionMatches: [
      ...
      },
      {
        ...
        note: "開始2分で2-0とし、本戦出場クラブを立ち上がりから圧倒した最終戦。GK児玉剛は自らゴールを決めたうえ、ムラッシュFCが切ったリバースPKでも相手のシュートをセーブして加点を呼び込み、公式速報に「GOAL & SAVE」と記された。",
      },
    ],
    mainRounds: [
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              body: [
                "35分、MURASH FCがシークレットカードの「[リバースPK](/glossary#card-reverse-penalty)」を使用した。リバースPKでは、カードを使った側が相手選手を指名してPKを蹴らせる。指名された選手が決めても得点にはならず、逆に外した場合はカードを使用した側、つまりMURASH FCに1点が加算される。",
