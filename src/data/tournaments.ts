...
export interface DetailItem {
  ...
  emphasized?: boolean;
  /**
   * 本文の直後に置く補足ボックス（NOTE スタイル）。
   * 前提知識がないと意味が伝わらない表現を補うために使う。
   */
  callout?: { title: string; body: string[] };
  /** 出典として明示する外部リンク（別タブで開く） */
...
export interface Tournament {
  ...
  upcoming?: boolean;
  /**
   * 本戦には参戦せず、エキシビションマッチのみで参加した大会は true。
   * 開催済みでも「世界大会出場回数」には数えない。
   */
  exhibitionOnly?: boolean;
  /** 個別ページの meta description を明示指定する（未指定なら汎用文を自動生成） */
...
export const tournaments: Tournament[] = [
      ...
      sections: [
        {
          ...
          items: [
            ...
            {
              title: "亡き両親へ捧ぐ。濱本和希の「ヒーロー」になる決意",
              emphasized: true,
              body: [
                "ブラジル大会のメンバーに選ばれた濱本和希が、自身の壮絶な生い立ちと大会にかける想いを告白した。",
  ...
  },
  {
    ...
    // 本戦には参戦せず、エキシビション4試合のみ。世界大会出場回数には数えない。
    exhibitionOnly: true,
    date: "2026年7月",
    format: "クラブ世界一決定戦（エキシビションマッチ参戦）",
    result: "4戦4勝（エキシビションマッチ）",
    record:
      "vs Zebras FC 9-2 → vs GEAR 7 FC 7-0 → vs Zeta Como 8-1 → vs UNDERDOGS FC 6-2",
    metaDescription:
      "キングス・ワールドカップ・クラブズ2026（イタリア・ミラノ）のエキシビションマッチ全4戦を、ムラッシュFCは4戦4勝・30得点5失点で戦い抜いた。全4戦のスコアと得点者、デビル太田、ノイアーよりノイアー、児玉剛のGOAL & SAVEまでファン目線で振り返ります。",
    highlight:
    ...
    episodes: [
      ...
      "児玉剛のGOAL & SAVE（第4戦）：試合開始1分にGK児玉剛が自らゴールを決めると、35分には相手が使ったシークレットカード「リバースPK」を児玉がセーブ。ルール上ムラッシュFCに1点が加算され、公式速報は「GOAL & SAVE」と表現した。",
    ],
    exhibitionMatches: [
      {
        no: "第1戦",
    ...
    detail: {
      ...
      sections: [
        {
          title: "ブラジルの3連敗から半年。新生ムラッシュFCが出した最初の答え",
          items: [
            {
              body: [
        ...
        {
          title: "第1戦｜Zebras FC（9-2）",
          items: [
            {
              title: "新生初陣で9得点。敗北の流れを止めた夜",
              body: [
                "新生MURASH FCの世界初陣は、開始直後から動いた。試合開始1分、宮内俊輔が先制ゴール。8分に白石郁哉、12分に横山航河が続き、13分には加藤純一が[プレジデントPK](/glossary#president-penalty)を成功させた。宮下豪也も15分に加点し、前半だけで5得点を奪った。",
                "後半には中村駿介が21分、22分、27分と立て続けにゴールを決め、ハットトリックを達成。最後は42分に木戸皓貴が9点目を奪い、常設化後初の海外戦を大勝で締めくくった。",
              ],
            },
            {
              title: "デビル太田――7対4という異様な光景",
              body: [
                "Zebras FCは立て続けのファウルでイエローカードを受け、2選手が一時退場。MURASH FCがすでに大きな人数差を得ているなか、太田宏介監督は[シークレットカード](/glossary#secret-card)の「[サスペンション](/glossary#card-suspension)」を発動し、相手をさらに1人減らした。",
                "ピッチ上に生まれたのは、MURASH FCの7人対Zebras FCの4人という、通常のサッカーではまず見られない状況。エキシビションマッチであっても一切手を緩めず、使えるルールをすべて使って勝ちに行く。その容赦のない采配から、太田監督はファンの間で「[デビル太田](/wiki/devil-ota)」と呼ばれるようになった。",
              ],
            },
            {
              title: "この試合が持った意味",
        ...
        {
          title: "第2戦｜GEAR 7 FC（7-0）",
          items: [
            {
              title: "攻撃だけではない。7-0で示したチームの完成度",
              body: [
                "初戦で9得点を奪ったMURASH FCは、第2戦でも攻撃の手を緩めなかった。8分に横山航河が先制。14分に小田崚平、17分に木戸皓貴が続き、前半を3点リードで終える。後半にも横山と木戸がそれぞれ2点目を記録し、林田大和も36分にゴール。最後は宮下豪也が[マッチボール](/glossary#match-ball)を決め、7-0で試合を終わらせた。",
              ],
            },
            {
              title: "「ノイアーよりノイアー」――深谷圭佑が守った3分間",
              body: [
              ...
              callout: {
                title: "「ノイアーよりノイアー」とは",
                body: [
                  "マヌエル・ノイアーは、ゴール前で待つだけでなく守備範囲を広く取り、相手より先に前へ飛び出して攻撃を止める「スイーパー・キーパー」の象徴的な存在。",
                  "林陵平の「ノイアーよりノイアーでした」は、深谷がノイアー本人より優れたGKだという比較ではない。**ノイアーの代名詞である広い守備範囲と大胆な飛び出しを、短時間に何度も体現してみせたことへの、最大級の賛辞**である。",
                ],
              },
              sourceLinks: [
                {
                  label: "ABEMA TIMESの記事を読む",
                  url: "https://times.abema.tv/articles/-/10264308",
                },
              ],
            },
            {
              title: "プレジデントPK失敗と“電波芸”",
              body: [
        ...
        {
          title: "第3戦｜Zeta Como（8-1）",
          items: [
            {
              title: "キングスリーグの理不尽さを味方につけた8-1",
              body: [
                "元イタリア代表のルカ・トーニがオーナーを務めるZeta Comoとの第3戦。この試合でもMURASH FCが主導権を握り、8-1で予定されていたエキシビション3試合の全勝を決めた。箱﨑裕也が得点し、白石郁哉と木戸皓貴もゴール。最後は白石がマッチボールを決めた。",
              ],
            },
            {
              title: "1分足らずで4点――ダブルゴールの破壊力",
              body: [
                "この試合を象徴したのが、前半終了間際の[ダブルゴールタイム](/glossary#double-goal-time)だった。",
              ...
              note: "得点の詳しい内訳とダブルゴールの適用状況は、公式映像を確認のうえ追記します。",
              sourceLinks: [
                {
                  label: "ABEMA TIMESの記事を読む",
                  url: "https://times.abema.tv/articles/-/10264440",
                },
              ],
            },
            {
        ...
        {
          title: "第4戦｜UNDERDOGS FC（6-2）",
          items: [
            {
              title: "前日に決まった第4戦。イタリアNo.1クラブも撃破",
              body: [
              ...
              sourceLinks: [
                {
                  label: "【緊急発表】加藤純一から重大発表（YouTube）",
                  url: "https://www.youtube.com/watch?v=x8cZAE0vVSI",
                },
              ],
            },
            {
              title: "開始2分で2-0。GK児玉剛が試合を動かす",
              body: [
                "試合開始最初のプレーでゴールを決めたのは、GKの児玉剛だった。1分に児玉が先制すると、2分には宮内俊輔が追加点。開始わずか2分で2-0とし、本戦出場クラブを立ち上がりから圧倒した。24分には中村駿介から木戸皓貴へつながる連係から3点目。33分には白石郁哉がゴールを決め、MURASH FCがリードを広げていった。",
              ],
            },
            {
              title: "児玉剛の「GOAL & SAVE」",
              body: [
                "35分、UNDERDOGS FCがシークレットカードの「[リバースPK](/glossary#card-reverse-penalty)」を使用した。リバースPKでは、カードを使った側が相手選手を指名してPKを蹴らせる。指名された選手が決めても得点は入らないが、外した場合には、カードを使用したチームの相手側へ1点が加算される。",
                "児玉剛は相手のPKをセーブ。その結果MURASH FCに1点が入り、公式速報では「GOAL & SAVE」と表現された。児玉は試合開始直後に自らゴールを決め、後半にはセーブによって再びチームへ得点をもたらした。GKが攻守の両方でスコアを動かす、キングスリーグならではの活躍だった。",
              ],
            },
            {
              title: "2人のGKが支えた勝利",
          ...
          items: [
            {
              body: [
                ...
                "新体制で臨んだ今大会の陣容は、プレジデントに加藤純一、共同オーナーに柿谷曜一朗、監督に太田宏介。ムラッシュFC戦は**ABEMAで全試合無料生中継**された。",
              ],
            },
          ],
        },
